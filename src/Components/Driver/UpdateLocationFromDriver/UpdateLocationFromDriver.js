        ...
        const fetchDriverData = async () => {
            try {
                const response = await axios.get(
                    `https://localhost:7032/api/Buses/CurrentLocationByDriverId?driverId=${driverId}`
                );
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const response = await axios.put(
                        `https://localhost:7032/api/Buses/UpdateCurrentLocation?driverId=${driverId}&currentLocation=${location}`,
                        {},
                        {
                            headers: {
